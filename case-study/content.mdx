...
# Building a space where TV lovers can finally keep track of everything they watch (and talk about it too)
...
<ContentSection>
# What makes Show-Hub different — a central place for shows, lists, and conversations
...
<ContentSection title="Lists management">
# Creating a more personal, flexible way to organize what you watch
...
# Writing and reading reviews — building conversations through words, not algorithms
...
<ContentSection title="Forums">
# Where discussions go beyond one-line reviews and become real conversations
...
# Keeping things accurate and up to date with real show information
...
# Under the hood — technologies that power everything behind the scenes
...
# Setting up the project locally — a quick note for developers who want to explore
...
# License and next steps — where the project goes from here
